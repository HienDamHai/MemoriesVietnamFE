...
export default function PaymentSuccess() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const res = await fetch(`https://localhost:7003/api/Payment/vnpay-return?${query}`);
  ...
  return (
    <div className="text-center py-20">
      ...
      <a href="/user/orders" className="mt-4 inline-block bg-amber-600 text-white px-4 py-2 rounded-lg">
        Quay lại đơn hàng
      </a>
    </div>
  );
